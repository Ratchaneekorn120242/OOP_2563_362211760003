...
public class Exercise_STD_Profile {
    ...
    public static void main(String[] args) {
        ...
        String std_tall = scanner.nextLine();
        ...
        System.out.println("----------------");
        System.out.println("ชือ-สกุล"+std_name);
        System.out.println("รหัสนักศึกษา"+std_id);
        System.out.println("อายุ"+std_age);
        System.out.println("เบอร์โทร"+std_tall);
        System.out.println("อีเมล"+std_email);
    }
}
